...
-- Name: lojavirtual_mentoria_teste; Type: DATABASE; Schema: -; Owner: postgres
-- TODO AQUI AO MIGRAR DEVE COMENTAR A PRIMEIRA LINHA DA CRIAÇÃO, A CONECÇÃO E ALTERAR O NOME DO BD
--CREATE DATABASE lojavirtual_mentoria_teste WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'Portuguese_Brazil.1252' LC_CTYPE = 'Portuguese_Brazil.1252';


ALTER DATABASE lojavirtual_mentoria_teste OWNER TO postgres;

--\connect lojavirtual_mentoria_teste
