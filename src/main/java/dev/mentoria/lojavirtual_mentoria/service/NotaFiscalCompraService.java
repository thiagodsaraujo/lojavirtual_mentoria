...
public class NotaFiscalCompraService {
    ...
    //PRECISA MUDAR O NOME DOS CAMPOS NO BANCO DE DADOS E NO OBJETO, sobre quantidade de estoque, estão mto parecidos
     ...
     * @param dataCompra e dataFinal são parametros obrigatórios
