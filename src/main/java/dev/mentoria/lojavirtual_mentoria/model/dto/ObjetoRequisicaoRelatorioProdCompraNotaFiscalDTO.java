...
public class ObjetoRequisicaoRelatorioProdCompraNotaFiscalDTO implements java.io.Serializable{


    // Está usando esse objeto para enviar e receber dados de uma requisição HTTP

    private static final long serialVersionUID = 1L;

    private String nomeProduto = ""; //iniciou como vazio para evitar nullpointer
